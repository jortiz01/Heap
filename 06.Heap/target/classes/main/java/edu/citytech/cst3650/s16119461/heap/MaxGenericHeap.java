...
public class MaxGenericHeap<T extends Comparable<T>> extends ComparisonHelper implements IGenericHeap, IGenericHeapQuery {
    ...
    private boolean isInvalidParent(int index){
        ...
        var status = isLessThan(this.items[index], this.getLeftChild(index))
                && isLessThan(this.items[index], this.getRightChild(index));
        return status;
    ...
    private void bubbleUp(){
        ...
        while(isGreaterThan(currentValue, parentValue)){
