...
public class MaxHeap implements IHeap, IHeapQuery {
    ...
    private List<Integer> findMin(int value, BiConsumer<Twin<Integer, Integer>, Twin<Integer, Integer>> biConsumer) {
        ...
        answer.add(result.get(count + index));
    ...
    private List<Integer> findMax(int value, BiConsumer<Twin<Integer, Integer>, Twin<Integer, Integer>> biConsumer) {
